# Prompt: Task [1.2] Define shared request/response models and error envelope
...
```md
You are implementing Vigil ticket 1.2.
...
<task>
- Implement exactly: Define shared request/response models and error envelope
- Ticket source: /home/shepard/dev/vigil/docs/tickets/00-unified-vigil-backlog.md (Epic 1, Task [1.2])
- Optional detailed guidance:
  - /home/shepard/dev/vigil/docs/tickets/epic-1-backend-foundation.md (Task [1.2])
...
- Allowed files/modules only:
  - /home/shepard/dev/vigil/src-tauri/src/models/*.rs
  - /home/shepard/dev/vigil/src-tauri/src/models/mod.rs
  - /home/shepard/dev/vigil/src-tauri/src/commands/*.rs
  - /home/shepard/dev/vigil/docs/specs/ipc-contracts.md
  - /home/shepard/dev/vigil/docs/implementation-diary/1.2.md
- Forbidden files/modules:
  - /home/shepard/dev/vigil/src/lib/**
  - /home/shepard/dev/vigil/.github/**
- Do not modify unrelated files.
</scope>

<non_goals>
- Do not implement:
  - Do not implement search/index logic beyond model typing.
- Do not change canonical command names in IPC spec.
</non_goals>
...
5. Run required checks/tests:
   ...
   - `rg -n "struct .*Response|struct .*Request|enum VigilError" src-tauri/src/models`
...
```json
{
  ...
  "diary_file": "/home/shepard/dev/vigil/docs/implementation-diary/1.2.md",
  "diary_updated": true,
  "changed_files": ["path"],
  "checks": [
