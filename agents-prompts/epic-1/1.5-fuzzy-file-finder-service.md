# Prompt: Task [1.5] Implement fuzzy file finder service for omnibar filename mode
...
```md
You are implementing Vigil ticket 1.5.
...
<task>
- Implement exactly: Implement fuzzy file finder service for omnibar filename mode
- Ticket source: /home/shepard/dev/vigil/docs/tickets/00-unified-vigil-backlog.md (Epic 1, Task [1.5])
- Optional detailed guidance:
  - /home/shepard/dev/vigil/docs/tickets/epic-1-backend-foundation.md (Task [1.5])
  - /home/shepard/dev/vigil/vigil-plan/epics/epic-1-backend/1.5-fuzzy-finder.md
  - /home/shepard/dev/vigil/docs/specs/ipc-contracts.md (`fuzzy_find`)
</task>
...
- Allowed files/modules only:
  ...
  - /home/shepard/dev/vigil/docs/implementation-diary/1.5.md
...
<non_goals>
- Do not implement:
  - Do not implement full-text content search here (1.6).
...
5. Run required checks/tests:
   ...
   - `rg -n "fuzzy_find|nucleo|score|matched" src-tauri/src`
...
```json
{
  ...
  "diary_file": "/home/shepard/dev/vigil/docs/implementation-diary/1.5.md",
  "diary_updated": true,
  "changed_files": ["path"],
  "checks": [
