<script lang="ts">
	/**
	 * NoteEditor -- Markdown editing surface with live preview toggle.
	 *
	 * Displays a file path header/tab area with a view-mode toggle button.
	 * In 'edit' mode: shows a monospace textarea for raw markdown editing.
	 * In 'preview' mode: shows rendered markdown via InlinePreview.
	 * Raw text is always preserved as the source of truth.
